    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeAdded', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoryType', models.CharField(choices=[('a', 'None'), ('b', 'Clothes'), ('c', 'Furniture'), ('d', 'Electronics'), ('e', 'Video Games'), ('f', 'Home Appliances'), ('g', 'Fashion'), ('h', 'Sports')], default='None', max_length=1)),
                ...
                ('listingOwner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listingOwner', to=settings.AUTH_USER_MODEL)),
                ('usersWatching', models.ManyToManyField(blank=True, related_name='listingsWatched', to=settings.AUTH_USER_MODEL)),
